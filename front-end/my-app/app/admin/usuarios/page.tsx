...
export default function AdminUsuarios() {
  ...
  async function carregarUsuarios() {
    ...
    try {
      ...
      const res = await fetch("https://protoserv-backend.up.railway.app/usuarios", {
  ...
  async function salvarUsuario() {
    ...
    try {
      ...
      const url = isEditar
        ? `https://protoserv-backend.up.railway.app/usuarios/${usuarioSelecionado!.id}`
        : "https://protoserv-backend.up.railway.app/usuarios";
  ...
  async function toggleAtivo(u: Usuario) {
    try {
      ...
      if (isAtivo(u)) {
        res = await fetch(`https://protoserv-backend.up.railway.app/usuarios/inativar/${u.id}`, {
          method: "DELETE",
          headers: { Authorization: `Bearer ${token}` },
        });
      } else {
        res = await fetch(`https://protoserv-backend.up.railway.app/usuarios/ativar/${u.id}`, {
          method: "PATCH",
          headers: { Authorization: `Bearer ${token}` },
        });
      }
